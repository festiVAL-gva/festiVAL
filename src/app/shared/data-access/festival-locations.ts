...
export const FESTIVAL_LOCATIONS: readonly FestivalLocation[] = [
  ...
  {
    key: 'arenal',
    nameKey: 'festivales.map.festivals.arenal.name',
    datesKey: 'festivales.map.festivals.arenal.dates',
    cityKey: 'festivales.map.festivals.arenal.city',
    provinceKey: 'festivales.map.festivals.arenal.province',
    descriptionKey: 'festivales.map.festivals.arenal.description',
    howToGetThereKey: 'festivales.map.festivals.arenal.howToGetThere',
