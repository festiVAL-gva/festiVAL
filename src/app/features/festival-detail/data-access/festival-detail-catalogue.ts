    ...
    posters: [
      {
        ...
        alt: 'Cartel vertical de Reve Festival Roig Arena Valencia 2026',
        width: 1080,
        height: 1350,
        featured: true,
      },
      ...
      {
        labelKey: 'festival.detail.byFestival.reve.overview.posterGallery.labels.kiddVoodoo',
        src: '/assets/images/festivals/reve/cartel-reve-kidd-voodoo-2026.webp',
        alt: 'Cartel de Kidd Voodoo para Reve Festival 2026',
        width: 900,
        height: 1125,
      },
      {
        labelKey: 'festival.detail.byFestival.reve.overview.posterGallery.labels.lorna',
        src: '/assets/images/festivals/reve/cartel-reve-lorna-2026.webp',
        alt: 'Cartel de Lorna para Reve Festival 2026',
        width: 900,
        height: 1125,
      },
      {
        labelKey: 'festival.detail.byFestival.reve.overview.posterGallery.labels.cMari',
        src: '/assets/images/festivals/reve/cartel-reve-c-mari-2026.webp',
        alt: 'Cartel de C Marí para Reve Festival 2026',
        width: 900,
        height: 1125,
      },
      {
        labelKey: 'festival.detail.byFestival.reve.overview.posterGallery.labels.laZowi',
        src: '/assets/images/festivals/reve/cartel-reve-la-zowi-2026.webp',
        alt: 'Cartel de La Zowi para Reve Festival 2026',
        width: 900,
        height: 1125,
      },
      {
        labelKey: 'festival.detail.byFestival.reve.overview.posterGallery.labels.rvfv',
        src: '/assets/images/festivals/reve/cartel-reve-rvfv-2026.webp',
        alt: 'Cartel de RVFV para Reve Festival 2026',
        width: 900,
        height: 1125,
      },
    ],
