...
│   └── merge-develop-into-branches.md → Fusión directa de develop en ramas remotas (variante simple; espejo en `.codex/commands/`)
...
| ---------- | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-29 | Simplificación de comandos Claude                       | `.claude/commands/autocommit.md` simplificado: detección de issue key desde la rama, sin gates embebidos ni pregunta interactiva por nº de issue. Eliminados `.claude/commands/{merge-to-develop,new-branch,update-branches-from-develop}.md` (los espejos en `.codex/commands/` se conservan). `README.md` y esta documentación actualizados. |
