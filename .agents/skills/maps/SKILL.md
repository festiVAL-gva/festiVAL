...
> bloqueado por X-Frame-Options) — ver `festival-location-map` y la fila Maps de `AGENTS.md`.
...
- **Custom dark style** matching the TuriaFest design system (deep navy land, muted gray streets, violet POI accents).
